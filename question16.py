...
def question16():  
    ...
    label2 = Label(root, text=" ข้อใดต่อไปนี้เป็น keyword ในภาษา Python 3 ทั้งหมด?", width=50, height = 5, bg="white")
    canvas.create_window(300, 105, anchor='center', window=label2)
    # label2.grid(column=0, row=1, columnspan=3, padx=10,pady=3)
    var = IntVar()
    r1 = Radiobutton(root, text="class, do, try", width=15, height=3, variable=var, value=1,
    ...
    r2 = Radiobutton(root, text="with, where, is", width=15, height=3 ,variable=var, value=2,
    ...
    r3 = Radiobutton(root, text="final, pass, assert", width=15, height=3, variable=var, value=3,
    ...
    r4 = Radiobutton(root, text="assert, from, pass", width=15, height=3, variable=var, value=4,
