...
def question15():  
    ...
    r3 = Radiobutton(root, text="Semantic  Errors", width=15, height=3, variable=var, value=3,
    ...
    r4 = Radiobutton(root, text="Value  Errors", width=15, height=3, variable=var, value=3,
