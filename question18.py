...
def question18():  
    ...
    r2 = Radiobutton(root, text="bool", width=15, height=3 ,variable=var, value=2,
    ...
    r3 = Radiobutton(root, text="float", width=15, height=3, variable=var, value=3,
    ...
    r4 = Radiobutton(root, text="string", width=15, height=3, variable=var, value=4,
