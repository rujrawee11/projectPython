...
def question4():  
    ...
    label2 = Label(frame, text="error ใดๆ ก็ตามที่เกิดขึ้นระหว่าง run program อยู่ คือข้อใด ?", width=50, height = 5, bg="white")
    label2.grid(column=0, row=1, columnspan=3, padx=10,pady=3)
    var = IntVar()
    r1 = Radiobutton(frame, text="Semantic  Errors", width=15, height=3, variable=var, value=1,
    ...
    r3 = Radiobutton(frame, text="Runtime Errors", width=15, height=3, variable=var, value=3,
                    bg="white", activebackground='green', command=sel)  # คำตอบสาม
    r3.grid(column=0, row=3, padx=15, pady=15)
    r4 = Radiobutton(frame, text="Value Errors", width=15, height=3, variable=var, value=4,
