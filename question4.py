...
def radiobutton():
    ...
    var = IntVar()
    r1 = Radiobutton(frame, text="Runtime Errors", width=15, height=3, variable=var, value=1)#คำตอบแรก
    r1.grid(column=0, row=2, padx=75, pady=30)
    r2 = Radiobutton(frame, text="Syntax Errors", width=15, height=3 ,variable=var, value=2)  # คำตอบสอง
