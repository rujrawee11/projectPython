...
def question4():  
    ...
    label2 = Label(root, text="error ใดๆ ก็ตามที่เกิดขึ้นระหว่าง run program อยู่ คือข้อใด ?", width=50, height = 5, bg="white")
    canvas.create_window(300, 105, anchor='center', window=label2)
    #label2.grid(column=0, row=1, columnspan=3, padx=10,pady=3)
    var = IntVar()
    r1 = Radiobutton(root, text="Semantic  Errors", width=15, height=3, variable=var, value=1,
    ...
    r2 = Radiobutton(root, text="Syntax Errors", width=15, height=3 ,variable=var, value=2,
    ...
    r3 = Radiobutton(root, text="Runtime Errors", width=15, height=3, variable=var, value=3,
    ...
    r4 = Radiobutton(root, text="Value Errors", width=15, height=3, variable=var, value=4,
