...
def question13():  
    ...
    label2 = Label(root, text="คำสั่งที่ใช้ในการให้เต่าเคลื่อนที่ไปข้างหน้าคือคำสั่งอะไร?", width=50, height = 5, bg="white")
    canvas.create_window(300, 105, anchor='center', window=label2)
    # label2.grid(column=0, row=1, columnspan=3, padx=10,pady=3)
    var = IntVar()
    r1 = Radiobutton(root, text="backward()", width=15, height=3, variable=var, value=1,
    ...
    r2 = Radiobutton(root, text="forward()", width=15, height=3 ,variable=var, value=2,
    ...
    r3 = Radiobutton(root, text="right()", width=15, height=3, variable=var, value=3,
    ...
    r4 = Radiobutton(root, text="left()", width=15, height=3, variable=var, value=4,
                    bg="white", activebackground='red', command=sel)  # คำตอบสาม
