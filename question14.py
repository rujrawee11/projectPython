...
def question14():  
    ...
    label2 = Label(root, text="คำสั่งใดใช้รับข้อมูลทางแป้นพิมพ์?", width=50, height = 5, bg="white")
    canvas.create_window(300, 105, anchor='center', window=label2)
    # label2.grid(column=0, row=1, columnspan=3, padx=10,pady=3)
    var = IntVar()
    r1 = Radiobutton(root, text="print()", width=15, height=3, variable=var, value=1,
    ...
    r2 = Radiobutton(root, text="compute()", width=15, height=3 ,variable=var, value=2,
    ...
    r3 = Radiobutton(root, text="output()", width=15, height=3, variable=var, value=3,
    ...
    r4 = Radiobutton(root, text="input()", width=15, height=3, variable=var, value=4,
