...
def question5():  
    ...
    r2 = Radiobutton(root, text="Generalization", width=15, height=3 ,variable=var, value=2,
    ...
    r3 = Radiobutton(root, text="Refactoring", width=15, height=3, variable=var, value=3,
    ...
    r4 = Radiobutton(root, text="Map", width=15, height=3, variable=var, value=4,
