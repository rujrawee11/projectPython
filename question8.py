...
def question8():  
    ...
    r2 = Radiobutton(root, text="1+2", width=15, height=3 ,variable=var, value=2,
    ...
    r3 = Radiobutton(root, text="12", width=15, height=3, variable=var, value=3,
    ...
    r4 = Radiobutton(root, text="3", width=15, height=3, variable=var, value=4,
