...
questions = [
    ...
    {
        "text": "islower() เอาไว้เช็คอะไร ?",  # ข้อคำถาม37
        "bg": "Q1",  # รูปภาพพื้นหลัง
        "choices": [
            # text คือ ตัวเลือกที่จะแสดงผล
            {"text": "ตัวพิมพ์ใหญ่", "id": 1, "isAnswer": False},
            # id ให้เป็นเลขที่ไม่ซ้ำกัน เพื่อระบุตัวเลือก แนะนำ 1,2,3,4
            {"text": "ตัวพิมพ์เล็ก", "id": 2, "isAnswer": True},
            # isAnswer คือ ตัวเลือกนี้เป็นคำตอบที่ถูกหรือไม่ True คือ คำตอบที่ถูกต้อง ส่วน False เป็นคำตอบที่ผิด
            {"text": "ตัวเลข", "id": 3, "isAnswer": False},
            {"text": "จำนวนตัวอักษร", "id": 4, "isAnswer": False}
        ]
    },
    {
        "text": "isupper() เอาไว้เช็คอะไร ?",  # ข้อคำถาม38
        "bg": "Q2",  # รูปภาพพื้นหลัง
        "choices": [
            # text คือ ตัวเลือกที่จะแสดงผล
            {"text": "ตัวพิมพ์เล็ก", "id": 1, "isAnswer": False},
            # id ให้เป็นเลขที่ไม่ซ้ำกัน เพื่อระบุตัวเลือก แนะนำ 1,2,3,4
            {"text": "จำนวนตัวอักษร", "id": 2, "isAnswer": False},
            # isAnswer คือ ตัวเลือกนี้เป็นคำตอบที่ถูกหรือไม่ True คือ คำตอบที่ถูกต้อง ส่วน False เป็นคำตอบที่ผิด
            {"text": "ตัวพิมพ์ใหญ่", "id": 3, "isAnswer": True},
            {"text": "ตัวเลข", "id": 4, "isAnswer": False}
        ]
    }
