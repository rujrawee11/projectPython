...
questions = [
    ...
    {
        # ข้อคำถาม2
        "text": "จงตอบผลลัพธ์​ของ function ตามนี้ \nint(3), float(3.14), str('Hello')​",
        "bg": "Q2",  # รูปภาพพื้นหลัง
        "choices": [
            # text คือ ตัวเลือกที่จะแสดงผล
            {"text": "3, 3.14, Hello", "id": 1, "isAnswer": True},
            # id ให้เป็นเลขที่ไม่ซ้ำกัน เพื่อระบุตัวเลือก แนะนำ 1,2,3,4
            {"text": "3, 3, 'Hello'", "id": 2, "isAnswer": False},
            # isAnswer คือ ตัวเลือกนี้เป็นคำตอบที่ถูกหรือไม่ True คือ คำตอบที่ถูกต้อง ส่วน False เป็นคำตอบที่ผิด
            {"text": "3, 3, Hello", "id": 3, "isAnswer": False},
    ...
    },
    {
        ...
        "choices": [
            # text คือ ตัวเลือกที่จะแสดงผล
            {"text": "Syntax Errors", "id": 1, "isAnswer": True},
            # id ให้เป็นเลขที่ไม่ซ้ำกัน เพื่อระบุตัวเลือก แนะนำ 1,2,3,4
            {"text": "Runtime Errors", "id": 2, "isAnswer": False},
            # isAnswer คือ ตัวเลือกนี้เป็นคำตอบที่ถูกหรือไม่ True คือ คำตอบที่ถูกต้อง ส่วน False เป็นคำตอบที่ผิด
            {"text": "Semantic  Errors", "id": 3, "isAnswer": False},
            {"text": "Value Errors", "id": 4, "isAnswer": False}
        ]
    },
    {
        "text": "error ใดๆ ก็ตามที่เกิดขึ้นระหว่าง run program อยู่คือข้อใด ?",  # ข้อคำถาม4
        "bg": "Q2",  # รูปภาพพื้นหลัง
        "choices": [
            # text คือ ตัวเลือกที่จะแสดงผล
            {"text": "Semantic  Errors", "id": 1, "isAnswer": False},
            # id ให้เป็นเลขที่ไม่ซ้ำกัน เพื่อระบุตัวเลือก แนะนำ 1,2,3,4
            {"text": "Syntax Errors", "id": 2, "isAnswer": False},
            # isAnswer คือ ตัวเลือกนี้เป็นคำตอบที่ถูกหรือไม่ True คือ คำตอบที่ถูกต้อง ส่วน False เป็นคำตอบที่ผิด
            {"text": "Runtime Errors", "id": 3, "isAnswer": True},
            {"text": "Value Errors", "id": 4, "isAnswer": False}
        ]
    },
    {
        ...
        "choices": [
            # text คือ ตัวเลือกที่จะแสดงผล
            {"text": "Encapsulation", "id": 1, "isAnswer": False},
            # id ให้เป็นเลขที่ไม่ซ้ำกัน เพื่อระบุตัวเลือก แนะนำ 1,2,3,4
            {"text": "Generalization", "id": 2, "isAnswer": False},
            # isAnswer คือ ตัวเลือกนี้เป็นคำตอบที่ถูกหรือไม่ True คือ คำตอบที่ถูกต้อง ส่วน False เป็นคำตอบที่ผิด
            {"text": "Refactoring", "id": 3, "isAnswer": True},
            {"text": "Map", "id": 4, "isAnswer": False}
        ]
    },
    {
        # ข้อคำถาม6
        "text": "ข้อใดคือคำตอบของผลลัพธ์​ function ดังต่อไปนี้ \nint('a'), str(1.0), int(100, 2), int('101', 2)",
        "bg": "Q2",  # รูปภาพพื้นหลัง
        "choices": [
            {"text": "Error, 1.0, 100,\n 2 , Error", "id": 1,
                "isAnswer": False},  # text คือ ตัวเลือกที่จะแสดงผล
            # id ให้เป็นเลขที่ไม่ซ้ำกัน เพื่อระบุตัวเลือก แนะนำ 1,2,3,4
            {"text": "'a',​ 1, Error, Error", "id": 2, "isAnswer": False},
            # isAnswer คือ ตัวเลือกนี้เป็นคำตอบที่ถูกหรือไม่ True คือ คำตอบที่ถูกต้อง ส่วน False เป็นคำตอบที่ผิด
            {"text": "'a',​ '1.0'​, 100,\n2 , 5 ", "id": 3, "isAnswer": False},
    ...
    },
    {
        ...
        "choices": [
            # text คือ ตัวเลือกที่จะแสดงผล
            {"text": "python", "id": 1, "isAnswer": False},
            # id ให้เป็นเลขที่ไม่ซ้ำกัน เพื่อระบุตัวเลือก แนะนำ 1,2,3,4
            {"text": "machine", "id": 2, "isAnswer": True},
            # isAnswer คือ ตัวเลือกนี้เป็นคำตอบที่ถูกหรือไม่ True คือ คำตอบที่ถูกต้อง ส่วน False เป็นคำตอบที่ผิด
            {"text": "high-level", "id": 3, "isAnswer": False},
            {"text": "natural", "id": 4, "isAnswer": False}
        ]
    },
    {
        # ข้อคำถาม8
        "text": " x = 1\ny = 2\nprint(x+y)\nผลลัพธ์ตามโปรแกรมนี้คือข้อใด ?",
        "bg": "Q2",  # รูปภาพพื้นหลัง
        "choices": [
            # text คือ ตัวเลือกที่จะแสดงผล
            {"text": "x+y", "id": 1, "isAnswer": False},
            # id ให้เป็นเลขที่ไม่ซ้ำกัน เพื่อระบุตัวเลือก แนะนำ 1,2,3,4
            {"text": "1+2", "id": 2, "isAnswer": False},
            # isAnswer คือ ตัวเลือกนี้เป็นคำตอบที่ถูกหรือไม่ True คือ คำตอบที่ถูกต้อง ส่วน False เป็นคำตอบที่ผิด
            {"text": "12", "id": 3, "isAnswer": True},
    ...
    },
    {
        ...
        "choices": [
            {"text": "tee         \nsunthon  y", "id": 1,
                "isAnswer": False},  # text คือ ตัวเลือกที่จะแสดงผล
            # id ให้เป็นเลขที่ไม่ซ้ำกัน เพื่อระบุตัวเลือก แนะนำ 1,2,3,4
            {"text": "sunthon  \nnoyna    ", "id": 2, "isAnswer": False},
            # isAnswer คือ ตัวเลือกนี้เป็นคำตอบที่ถูกหรือไม่ True คือ คำตอบที่ถูกต้อง ส่วน False เป็นคำตอบที่ผิด
            {"text": "neay       \nnoyna     ", "id": 3, "isAnswer": True},
    ...
    },
    {
        ...
        "choices": [
            # text คือ ตัวเลือกที่จะแสดงผล
            {"text": "word[-1]     ", "id": 1, "isAnswer": True},
            # id ให้เป็นเลขที่ไม่ซ้ำกัน เพื่อระบุตัวเลือก แนะนำ 1,2,3,4
            {"text": "word[6:8]    ", "id": 2, "isAnswer": False},
            # isAnswer คือ ตัวเลือกนี้เป็นคำตอบที่ถูกหรือไม่ True คือ คำตอบที่ถูกต้อง ส่วน False เป็นคำตอบที่ผิด
            {"text": "word[4:]      ", "id": 3, "isAnswer": False},
    ...
    },
    {
        ...
        "bg": "Q1",  # รูปภาพพื้นหลัง
        "choices": [
            {"text": "a = {1, 2, 3, 4, 5}    ", "id": 1,
                "isAnswer": False},  # text คือ ตัวเลือกที่จะแสดงผล
            # id ให้เป็นเลขที่ไม่ซ้ำกัน เพื่อระบุตัวเลือก แนะนำ 1,2,3,4
            {"text": "a = (1, 2, 3, 4, 5)    ", "id": 2, "isAnswer": False},
            # isAnswer คือ ตัวเลือกนี้เป็นคำตอบที่ถูกหรือไม่ True คือ คำตอบที่ถูกต้อง ส่วน False เป็นคำตอบที่ผิด
            {"text": "a = <1, 2, 3, 4, 5> ", "id": 3, "isAnswer": False},
    ...
    },
    {
        ...
        "bg": "Q2",  # รูปภาพพื้นหลัง
        "choices": [
            {"text": "True and True or False and True       ", "id": 1,
                "isAnswer": False},  # text คือ ตัวเลือกที่จะแสดงผล
            # id ให้เป็นเลขที่ไม่ซ้ำกัน เพื่อระบุตัวเลือก แนะนำ 1,2,3,4
            {"text": "False and True or False and True      ",
                "id": 2, "isAnswer": True},
            # isAnswer คือ ตัวเลือกนี้เป็นคำตอบที่ถูกหรือไม่ True คือ คำตอบที่ถูกต้อง ส่วน False เป็นคำตอบที่ผิด
            {"text": "True or (8-5 == 3) and True or False",
             "id": 3, "isAnswer": False},
            {"text": "(2 >= 0) or (-5 <= -8)                         ",
             "id": 4, "isAnswer": False}
        ]
    },
    {
        ...
        "choices": [
            # text คือ ตัวเลือกที่จะแสดงผล
            {"text": "backward()", "isAnswer": False, "id": 1},
            # id ให้เป็นเลขที่ไม่ซ้ำกัน เพื่อระบุตัวเลือก แนะนำ 1,2,3,4
            {"text": "forward()", "isAnswer": True, "id": 2},
            # isAnswer คือ ตัวเลือกนี้เป็นคำตอบที่ถูกหรือไม่ True คือ คำตอบที่ถูกต้อง ส่วน False เป็นคำตอบที่ผิด
            {"text": "right()", "isAnswer": False, "id": 3},
            {"text": "left()", "isAnswer": False, "id": 4}
        ]
    },
    {
...
def get_rand_question():
    return random.choice(questions)#แรนด้อมคำถาม
